        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "14px 28px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              {mode === "admin" && <Tag color={C.violet} bg={C.violetLight} style={{ marginLeft: 4 }}>ADMIN</Tag>}
            </div>
          </div>
          <div style={{ display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }}>
            {mode === "borrower" && (
              <>
                ...
                {adminAuth
                  ? <button onClick={() => setMode("admin")} style={{ background: "none", border: "none", color: C.border, fontSize: 10, cursor: "pointer", fontFamily: FONT, padding: "4px 8px" }}>←</button>
                  : <button onClick={() => setShowLogin(true)} style={{ background: "none", border: "none", color: C.border, fontSize: 10, cursor: "pointer", fontFamily: FONT, padding: "4px 8px" }}>•</button>
                }
              </>
            )}
            {mode === "admin" && (
                    ...
                    <div key={d.id} className="deal-card"
                      ...
                      <div style={{ position: "relative", height: 180, overflow: "hidden", background: C.surface }}>
                        ...
                        <div style={{ position: "absolute", bottom: 12, left: 14, right: 14 }}>
                          <div style={{ fontSize: 14, color: "#fff", fontWeight: 700, textShadow: "0 1px 4px rgba(0,0,0,0.5)" }}>{d.market}</div>
                          <div style={{ fontSize: 12, color: "rgba(255,255,255,0.9)", fontWeight: 500, marginTop: 1 }}>ZIP {d.zip}</div>
                        </div>
                      </div>
